...
namespace XtremeFPS.CustomEditors
{
    ...
    public class WeaponSystemEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            uni_WeaponSystem.fpsController = (PlayerMovementController)EditorGUILayout.ObjectField(new GUIContent("Player Controller", "Reference to player controller script."), uni_WeaponSystem.fpsController, typeof(PlayerMovementController), true);
