...
namespace XtremeFPS.TPSController
{
    [RequireComponent(typeof(CharacterController))]
    [RequireComponent(typeof(XtremeFPSInputHandler))]
    [RequireComponent(typeof(AudioSource))]
    [AddComponentMenu("Spoiled Unknown/XtremeFPS/Third Person Controller")]
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            //cameraFollow.Rotate(mouseDirectionX * transform.up);
            cameraFollow.localRotation = Quaternion.Euler(rotationY, rotationX, 0f);
